        ...
        child: GridView.count(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('Resources Demo'),
            ),
            ElevatedButton(
              onPressed: () => context.push('/sampling'),
              child: const Text('Sampling Demo'),
            ),
            ElevatedButton(
              onPressed: () => context.push('/baggage'),
              child: const Text('Baggage Demo'),
            ),
          ],
        ),
      ),

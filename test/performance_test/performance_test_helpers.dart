...
import 'package:embrace_flutter_dartastic/screens/performance_demo_screen.dart';
...
void resetPerformanceTrackers() {
  FrameRateTracker.instance.reset();
  JankDetector.instance.reset();
  FrameMetricsExporter.instance.reset();
}

Widget buildPerformanceTestWidget() {

...
import 'package:embrace_flutter_dartastic/screens/lifecycle_demo_screen.dart';
...
void resetLifecycleStore() {
  LifecycleEventStore.instance.reset();
  LaunchTracker.instance.reset();
  ForegroundTracker.instance.reset();
  LifecycleMetrics.instance.reset();
}

Widget buildLifecycleTestWidget() {
